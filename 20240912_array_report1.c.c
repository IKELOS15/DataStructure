...
void printScore(int scores[], int size, int avg, int opt);
int main() {
    ...
    //평균점수 이상 학생 정보 검색[실습과제]
    printf("0은 모든 학생, 1은 평균 이상 학생, 2는 평균 미만: ");
    scanf("%d", &opt);

    printScore(scores, 30, average, opt);
